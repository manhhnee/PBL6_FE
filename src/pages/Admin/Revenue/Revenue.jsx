...
function Revenue() {
  ...
  useEffect(() => {
    const fetchApiRevenue = async (fromDate, toDate) => {
      const response = await axios.get('http://54.164.6.175:3000/api/revenue', {
        params: {
          startDate: fromDate,
          endDate: toDate,
        },
    ...
    const fetchAPICustomers = async (fromDate, toDate) => {
      const response = await axios.get('http://54.164.6.175:3000/api/revenue/customer', {
        params: {
          startDate: fromDate,
          endDate: toDate,
        },
    ...
    const fetchAPIShoes = async (fromDate, toDate) => {
      const response = await axios.get('http://54.164.6.175:3000/api/revenue/product', {
        params: {
          startDate: fromDate,
          endDate: toDate,
        },
